...
"""Verify that starting TCC with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start TCC with -h for help text")
        ...
        self.log.info("Start TCC with -version for version information")
        ...
        self.log.info("Start TCCd with -fakearg to make sure it does not start")
