# Support for Output Descriptors in TCC Core

Since TCC Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `TCC1...` for mainnet or `tTCC1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on TCC's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing TCC Core wallets, a convenience function `combo` is
