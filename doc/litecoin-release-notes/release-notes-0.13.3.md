TCC Core version 0.13.3 is now available from:

  <https://download.TCC.org/TCC-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/TCC-project/TCC/blob/0.13/src/chainparams.cpp#L214).
