...
TCC.conf        | contains configuration settings for TCCd or TCC-qt
TCCd.pid        | stores the process id of TCCd while running
...
debug.log           | contains debug information and general logging generated by TCCd or TCC-qt
