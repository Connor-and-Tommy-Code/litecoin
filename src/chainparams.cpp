...
{
    const char* pszTimestamp = "BBC News 08/Oct/2021 Facebook and Instagram: Our childhoods were stolen by social media";
...
//        vSeeds.emplace_back("seed-a.TCC.loshan.co.uk");
//        vSeeds.emplace_back("dnsseed.thrasher.io");
//        vSeeds.emplace_back("dnsseed.TCCtools.com");
//        vSeeds.emplace_back("dnsseed.TCCpool.org");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,50);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,65);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x44, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x44, 0x88, 0xAD, 0xE4};

        bech32_hrp = "TCC";

        vFixedSeeds = std::vector<SeedSpec6>(pnSeed6_main, pnSeed6_main + ARRAYLEN(pnSeed6_main));

        fDefauTCConsistencyChecks = false;
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1633736172, 2084843521, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x2f97c275a1820603affb0f6279562eafb98c5f2e9b9eaa86dfddfcf857dc3c0b"));
        assert(genesis.hashMerkleRoot == uint256S("0xa35068ca5318936f6fdfd8cd887f69244352554ffc533aaf5382b84cdf5016dd"));

//        vFixedSeeds.clear();
//        vSeeds.clear();
//        // nodes with support for servicebits filtering should be at the top
//        vSeeds.emplace_back("testnet-seed.TCCtools.com");
//        vSeeds.emplace_back("seed-b.TCC.loshan.co.uk");
//        vSeeds.emplace_back("dnsseed-testnet.thrasher.io");
        ...
        checkpointData = {
            {
                {0, uint256S("0x2f97c275a1820603affb0f6279562eafb98c5f2e9b9eaa86dfddfcf857dc3c0b")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        fDefauTCConsistencyChecks = true;
        fRequireStandard = false;
