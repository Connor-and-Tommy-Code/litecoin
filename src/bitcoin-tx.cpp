...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " TCC-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  TCC-tx [options] <hex-tx> [commands]  Update hex-encoded TCC transaction\n" +
            "or:     TCC-tx [options] -create [commands]   Create hex-encoded TCC transaction\n" +
            "\n";
