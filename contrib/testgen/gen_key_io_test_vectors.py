...
bech32_templates = [
  ...
  ('TCC',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('TCC',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('TCC',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tTCC',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tTCC',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tTCC',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rTCC',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rTCC',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rTCC', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tTCC',  17, 32, False, False, False),
  ('rTCC',  3,  1, False, False, False),
  ('TCC',   15, 41, False, False, False),
  ('tTCC',  0, 16, False, False, False),
  ('rTCC',  0, 32, True,  False, False),
  ('TCC',   0, 16, True,  False, False),
  ('tTCC',  0, 32, False, True,  False),
  ('rTCC',  0, 20, False, False, True)
]
